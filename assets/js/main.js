...
function sendEmail() {
    ...
    let content = document.getElementById("contact-message").value
    Email.send({
        SecureToken: "31ea5f47-4b0b-4976-82c9-a48295ea6316",
        To: 'muhammad15-2997@diu.edu.bd',
        From: "muhammad15-2997@diu.edu.bd",
